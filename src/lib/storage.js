const KEYS = { jobs: 'jobpilot.jobs.v1', resumes: 'jobpilot.resumes.v1', settings: 'jobpilot.settings.v1', applicationProfile: 'jobpilot.application-profile.v1', seen: 'jobpilot.seen.v1' }
